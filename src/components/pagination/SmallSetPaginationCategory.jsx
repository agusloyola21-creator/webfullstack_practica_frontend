...
import { readBlogsByCategotyPage } from '../../redux/blog/blogActions';

function SmallSetPagination({ list, count, slug}){
    const [active, setActive] = useState(1);
    const [listingsPerPage, ] = useState(4);
    ...
    const visitPage = (page) => {
        ...
        setCurrentPage(page);
        setActive(page);
        dispatch(readBlogsByCategotyPage({p:page, slug:slug}))
    }
