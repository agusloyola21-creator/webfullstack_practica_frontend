...
import SmallSetPaginationCategory from 'components/pagination/SmallSetPaginationCategory'


const ListBlog = ({ blogs, count, slug = "" }) => {
  return (
    <>
      ...
      {slug !== "" ? (
        <SmallSetPaginationCategory list={blogs} count={count} slug={slug} />
      ) : (
        <SmallSetPagination list={blogs} count={count} />
      )}
